...
- **Scenario suite**: twelve personas (cooperative, chatty, vague, lonely, refusing, forgot her pills, dizzy and unfed, a fall, a message for Anna, a new appointment, chest tightness, fallen and stuck) run through the host with checks on recorded fields, flags, concern level and alerts; deterministic against the scripted host and as an evaluation against Claude on Bedrock, transcripts kept.
