...
- **Scenario suite**: twelve personas (cooperative, chatty, vague, lonely, refusing, forgot her pills, dizzy and unfed, a fall, a message for Anna, a new appointment, chest tightness, fallen and stuck) run through the host with checks on recorded fields, flags, concern level and alerts; deterministic against the scripted host (12/12) and as an evaluation against Claude Sonnet 4.6 on Bedrock (12/12, transcripts kept in the repo).
